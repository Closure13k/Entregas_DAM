...
public class form extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(468, 558));
        setMinimumSize(new java.awt.Dimension(468, 558));
        setPreferredSize(new java.awt.Dimension(468, 558));
        setResizable(false);

        pnlDataLicense.setMaximumSize(new java.awt.Dimension(436, 386));
        pnlDataLicense.setMinimumSize(new java.awt.Dimension(436, 386));

        pnlLicense4.setBorder(javax.swing.BorderFactory.createTitledBorder("Titulación Máxima"));
        ...
        pnlStudies.setBorder(javax.swing.BorderFactory.createTitledBorder("Titulación Máxima"));
    ...
    private Person generateNewPerson() throws PersonException {
        //Valida datos
        String DNI, name, surnameOne, surnameTwo;
        DNI = validateField(txtDNI.getText(), "DNI");
        name = validateField(txtName.getText(), "Nombre");
        surnameOne = validateField(txtSurnameTwo.getText(), "Apellido 1");
        surnameTwo = validateField(txtSurnameOne.getText(), "Apellido 2");
        Person person = new Person(
                DNI, name, surnameOne, surnameTwo,
    ...
    private String validateField(String value, String field) throws PersonException {
        if (value.isBlank()) {
            throw new PersonException("El campo " + field + " no puede estar vacío.");
        }
        return value;
    }
